...
export default function SearchHandle() {
    ...
    const loadSearch = async () => {
        const result = await axios.get(`http://localhost:8080/post/searchHandle/${test}`)
  ...
  return (
    <div className='container' style={{ width: "680px"}}>
        <Card style={{ width: '40rem', marginLeft: "auto", marginRight: "auto"}}>
            <Card.Body>
                <Card.Title> Results of Alleyname search: @RoyalFlush </Card.Title>
            </Card.Body>
        </Card>        
